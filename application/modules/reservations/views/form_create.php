<div class="row">
	<div class="span16">
		...
		<ul>
			...
			<input type='text' name='reservation_num' id='reservation_num' class='span10'>
		</li>
		<li>
		...
		<li>
			...
			<input type='text' name='last_name' id='last_name' class='span10'>
		</li>
		<li>
			<label for='gross_rate'>Monto</label>
			<input type='text' name='gross_rate' id='gross_rate' class='span10'>
		</li>
		<li>
			<label for='taxes'>Impuestos</label>
			<input type='text' name='taxes' id='taxes' class='span10'>
		</li>
		<li>
			<label for='others'>Otros</label>
			<input type='text' name='others' id='others' class='span10'>
		</li>
		<li>
			<label for='reservation_date'>Fecha de Reserva</label>
			<input type='text' name='reservation_date' id='reservation_date' class='span10'>
		</li>
		<li>
			<label for='sailing_date'>Fecha de Salida</label>
			<input type='text' name='sailing_date' id='sailing_date' class='span10'>
		</li>
		<li>
			<label for='id_ship'>Barco</label>
			<?php echo form_dropdown('id_ship', $ships, '', "name='id_ship' id='id_ship'"); ?>
			</li>
			<li>
